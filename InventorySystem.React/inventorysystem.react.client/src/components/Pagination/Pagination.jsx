function Pagination({
    ...
    return (
        <div className="flex flex-row items-center justify-between mt-4 px-2 py-2 gap-4 w-full flex-wrap sm:flex-nowrap">
            ...
            <div className="flex items-center gap-2">
                <button
                    className="px-4 py-2 rounded-xl border border-gray-200 text-sm font-semibold hover:bg-blue-500 hover:text-white text-gray-600 bg-white hover:border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm"
                ...
                <button
                    className="px-4 py-2 rounded-xl border border-gray-200 text-sm font-semibold text-gray-600 bg-white hover:bg-blue-500 hover:text-white hover:border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm"
