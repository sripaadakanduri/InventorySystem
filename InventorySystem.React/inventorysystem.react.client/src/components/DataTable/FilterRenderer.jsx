            ...
            return (
                <div className="flex justify-center">
                    <select
                        ...
                        value={value ?? ""}
                        onChange={handleChange}
                        className={`border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none font-medium text-gray-600 focus:ring-2 focus:ring-blue-400 ${filter.className ?? "w-32"}`}
                    >
