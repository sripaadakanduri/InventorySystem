        ...
        return (
            <div className="max-w-7xl mx-auto p-6 mt-8">
                <div className="flex justify-between items-center mb-8">
                    ...
                    <button
                        className="flex items-center gap-2 bg-blue-500 hover:bg-blue-700 hover:rotate-90 text-white px-5 py-5 rounded-full font-semibold shadow-md hover:scale-105 hover:rotate-1 transition-transform duration-200" onClick={() => setShowAddModal(true)}
                    >
